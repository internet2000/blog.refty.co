...
• **16 : 00**. Ensuite, je reporte à mon tour à mon DRH . Je m'appuie sur un certain nombre d'outils comme l'ATS pour collecter des **données**. Le.a Head of Talent Acquisition est complètement [data driven](https://www.elevo.fr/post/les-people-analytics-une-revolution-pour-les-rh).
